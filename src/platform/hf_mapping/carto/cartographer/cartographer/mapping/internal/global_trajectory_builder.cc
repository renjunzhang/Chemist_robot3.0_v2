...
class GlobalTrajectoryBuilder : public mapping::TrajectoryBuilderInterface {
 public:
  ...
  void AddSensorData(
    ...
    std::unique_ptr<InsertionResult> insertion_result;//和matching_result里面的InsertionResult不是一个东西
    ...
    // 将结果数据传入回调函数中, 进行保存 map_build_bridge 144行的表达式，OnLocalSlamResult回调函数
