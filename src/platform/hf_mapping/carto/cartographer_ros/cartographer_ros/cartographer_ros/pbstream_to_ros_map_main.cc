...
DEFINE_string(pbstream_filename, "/home/shao/sourcecode/c++/aichem_cartographer/src/cartographer_ros/cartographer_ros/configuration_files/aichem_map_tmp.pbstream",
              "Filename of a pbstream to draw a map from.");
DEFINE_string(map_filestem, "/home/shao/sourcecode/c++/aichem_cartographer/src/cartographer_ros/cartographer_ros/configuration_files/aichem_map_tmp1", "Stem of the output files.");
