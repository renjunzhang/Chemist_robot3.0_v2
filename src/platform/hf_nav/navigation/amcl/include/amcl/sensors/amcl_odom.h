...
public:
  ...
  // Change in odometric pose //里程计位姿加上噪声的变化量
public:
  pf_vector_t delta;
};

// Odometric sensor model
//主要的功能是定义不同运动模型的输入参数，以及通过运动来更新粒子滤波器
...
public:
  void SetModel(odom_model_t type, double alpha1, double alpha2, double alpha3,
                double alpha4, double alpha5 = 0);
